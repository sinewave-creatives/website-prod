...
exports.executeCreateCLISessionEventMutation = exports.fetchListNetlifyEnabledServicesQuery = exports.fetchSharedDocumentQuery = exports.executeCreateSharedDocumentMutation = exports.fetchListSharedDocumentsQuery = exports.executeCreateGraphQLSchemaMutation = exports.executeCreateApiTokenMutation = exports.executeMarkCliSessionInactive = exports.executeMarkCliSessionActiveHeartbeat = exports.fetchEnabledServicesForSession = exports.fetchEnabledServicesForApp = exports.ensureAppForSite = exports.createNewAppSchema = exports.upsertAppForSite = exports.fetchAppSchemaQuery = exports.eventAudience = exports.friendlyEventName = exports.executeCreatePersistedQueryMutation = exports.ackCLISessionEvents = exports.updateCLISessionMetadata = exports.createCLISession = exports.fetchCliSessionEvents = exports.fetchCliSession = exports.fetchPersistedQuery = exports.fetchOneGraphSchemaForServices = exports.fetchOneGraphSchemaForServicesJson = exports.fetchOneGraphSchemaById = exports.fetchOneGraphSchemaByIdJson = exports.getGraphJwtForSite = void 0;
 ...
 * @returns
 */
var fetchEnabledServicesForSession = function (jwt, siteId, sessionId) { return __awaiter(void 0, void 0, void 0, function () {
    var appSchemaResult;
    var _a, _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                appSchemaResult = _d.sent();
                return [2 /*return*/, (_c = (_b = (_a = appSchemaResult.data) === null || _a === void 0 ? void 0 : _a.oneGraph) === null || _b === void 0 ? void 0 : _b.netlifyCliSession.graphQLSchema) === null || _c === void 0 ? void 0 : _c.services];
        }
    });
}); };
exports.fetchEnabledServicesForSession = fetchEnabledServicesForSession;
/**
